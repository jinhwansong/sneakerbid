...
if (!process.env.KAKAO_CLIENT_ID)
  process.env.KAKAO_CLIENT_ID = 'e2e-placeholder';
if (!process.env.KAKAO_CLIENT_SECRET)
  process.env.KAKAO_CLIENT_SECRET = 'e2e-placeholder';
if (!process.env.KAKAO_CALLBACK_URL)
  process.env.KAKAO_CALLBACK_URL = 'http://localhost:4000/auth/kakao/callback';
if (!process.env.GOOGLE_CLIENT_ID)
  process.env.GOOGLE_CLIENT_ID = 'e2e-placeholder';
if (!process.env.GOOGLE_CLIENT_SECRET)
  process.env.GOOGLE_CLIENT_SECRET = 'e2e-placeholder';
