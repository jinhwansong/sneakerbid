...
- [x] E2E 테스트 *(완료: Backend Jest E2E, Frontend Playwright 비로그인 플로우)*
...
| 3 | 📚 스토리북 | Storybook 설치, 공통/도메인 컴포넌트 스토리 | 하 |
...
| **E2E 테스트** | *(완료: Backend Nest E2E, Frontend Playwright 비로그인 플로우)* |
